          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-2">
            ...
            <div className="relative">
              ...
              <div aria-hidden="true" className="flex items-center gap-2 bg-cream dark:bg-ink border border-stone-300 dark:border-stone-300 rounded-3xl p-2 hover:bg-stone-300/10 dark:hover:bg-stone-300 transition-colors pointer-events-none">
                ...
                <div className="font-black text-md md:text-xl leading-none dark:text-cream">{baseCurrency}</div>
                <CaretDownIcon weight="bold" className="text-stone-500 ml-2" />
              </div>
            </div>
          </div>
          {currency.name && <p className="md:absolute md:bottom-2 md:right-6 text-[10px] font-bold text-stone-400 dark:text-stone-400 uppercase tracking-widest mt-1">{baseCurrency} = {currency.name}</p>}
        </div>
      </div>
